...
-- Version: 1.2 (Slightly Edited)

AddCSLuaFile( )

if SERVER then
   resource.AddFile("materials/vgui/ttt/icon_bun_gravity_gun.png")
end
...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = "A tractor beam-type weapon,\noriginally designed for handling hazardous materials"
   };

   SWEP.Icon = "vgui/ttt/icon_bun_gravity_gun.png"
end
